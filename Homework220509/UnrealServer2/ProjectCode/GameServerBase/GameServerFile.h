...
public:		
	GameServerFile(); // default constructer 디폴트 생성자

	GameServerFile(const char* _Path); // default constructer 디폴트 생성자

	GameServerFile(const std::filesystem::path& _Path); // default constructer 디폴트 생성자

	GameServerFile(const std::string& _Path); // default constructer 디폴트 생성자

	GameServerFile(const std::string& _Path, const std::string& _Mode); // default constructer 디폴트 생성자

	~GameServerFile(); // default destructer 디폴트 소멸자

public:		// delete constructer
	GameServerFile(const GameServerFile& _other) = delete; // default Copy constructer 디폴트 복사생성자
	GameServerFile(GameServerFile&& _other) noexcept; // default RValue Copy constructer 디폴트 RValue 복사생성자

public:		//delete operator
	GameServerFile& operator=(const GameServerFile& _other) = delete; // default Copy operator 디폴트 대입 연산자
	GameServerFile& operator=(const GameServerFile&& _other) = delete; // default RValue Copy operator 디폴트 RValue 대입연산자
