...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_UnrealClient_ClientAnimationType_Hash() { return 121973699U; }
	UEnum* Z_Construct_UEnum_UnrealClient_ClientAnimationType()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "ClientAnimationType::Death", (int64)ClientAnimationType::Death },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "BlueprintType", "true" },
				{ "Death.DisplayName", "\xec\xa3\xbd\xeb\x8a\x94 \xec\x95\xa0\xeb\x8b\x88\xeb\xa9\x94\xec\x9d\xb4\xec\x85\x98" },
				{ "Death.Name", "ClientAnimationType::Death" },
